...
annealing strategy, this involves storing information about the replusion in
...
\begin{equation}
\exists d_\infty : \forall d > d_\infty, f_g(d) = 0
\end{equation}
...
replusion force is $O(n \centerdot \rho)$, where $\rho$ is the average spatial
density of nodes.
