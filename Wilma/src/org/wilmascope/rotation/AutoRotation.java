 ...
 *  bg.addChild(rotator);
 *   </pre></blockquote>
 * The above code will add the AutoRotation object to the branchgroup
 * group. 
 */
...
/**
 *@param target The TransformGroup AutoRotation will manipulate
 */
 ...
 *@param duration The time between mouse pressed and mouse released
 *@param angleX During the mouse drag, how much angle has been rotated around the x axis 
 *@param angleY During the mouse drag, how much angle has been rotated around the y axis
 */
