...
public class ParamsPanel extends JPanel implements ActionListener {
  ...
  JSlider maxBarrierSlider = new JSlider(
      (int) (Defaults.MIN_BARRIER_RATE * 100), 100,
      (int) (Defaults.MAX_BARRIER_RATE * 100));

  JSlider minBarrierSlider = new JSlider(0,
      (int) (Defaults.MAX_BARRIER_RATE * 100),
      (int) (Defaults.MIN_BARRIER_RATE * 100));

  JSlider boilLenSlider = new JSlider(0, 100,
      (int) (Defaults.BOIL_LENGTH * 100));

  JSlider quenchLenSlider = new JSlider(0, 100 - boilLenSlider.getValue(),
      (int) (Defaults.QUENCH_LENGTH * 100));
  ...
  JCheckBox barrierCheck = new JCheckBox("Barrier-jumping while boiling",
      Defaults.BOIL_BARRIER);
  ...
  public ParamsPanel(GraphControl.ClusterFacade root) {
    ...
    boilLenSlider
        .setBorder(new TitledBorder("Time spent in boiling phase (%)"));
    ...
    quenchLenSlider.setBorder(new TitledBorder(
        "Time spent in quenching phase (%)"));
