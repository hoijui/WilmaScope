...
/**
 * EdgeViews which need to monitor their nodes' geometry so that they
 * can update themselves accordingly, can implement this interface
 * 
 * @author dwyer
 */
public interface NodeGeometryObserver {
   ...
   * @param nv the node being observed
   */
