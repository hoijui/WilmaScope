...
public class Colours {
  ...
  throws UnknownMaterialException {
    if(name.equals(redMaterial.toString())) return redMaterial;
    else if(name.equals(blueMaterial.toString())) return blueMaterial;
    else if(name.equals(pinkMaterial.toString())) return pinkMaterial;
    else if(name.equals(greenMaterial.toString())) return greenMaterial;
    else if(name.equals(whiteMaterial.toString())) return whiteMaterial;
    else if(name.equals(momentIntervalMaterial.toString())) return momentIntervalMaterial;
    else if(name.equals(thingMaterial.toString())) return thingMaterial;
    else if(name.equals(roleMaterial.toString())) return roleMaterial;
    else if(name.equals(descriptionMaterial.toString())) return descriptionMaterial;
    else if(name.equals(defaultMaterial.toString())) return defaultMaterial;
    else throw new UnknownMaterialException(name);
  }
}
