...
public class GenerateTestGraphFrame extends JFrame implements ActionListener {
  ...
  public static final int RANDOM = 1, GRID = 2, CLUSTER = 3, STRATIFIED = 4;
  ...
  JRadioButton stratifiedRadio = new JRadioButton("Stratified", gen == STRATIFIED);
  ...
  public GenerateTestGraphFrame(String title, TestGraph tg) {
  ...
  private void jbInit() throws Exception {
    ...
    stratifiedRadio.setActionCommand("stratified");

    radioGroup.add(stratifiedRadio);
    ...
    stratifiedRadio.addActionListener(this);
    ...
    radioPanel.add(stratifiedRadio);
...
//    buttonPanel.setBorder(new TitledBorder(""));
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if(e.getActionCommand().equals("OK")) {
    ...
    else if(e.getActionCommand().equals("stratified")){

      gen = STRATIFIED;

      nodesSlider.setBorder (new javax.swing.border.TitledBorder("Number of columns"));

      edgesSlider.setBorder (new javax.swing.border.TitledBorder("Number of edges"));

      nodesSlider.setMaximum(50);

      nodesSlider.setMinimum(0);

      nodesSlider.setMinorTickSpacing (5);
      ...
      edgesSlider.setMinorTickSpacing (10);

      edgesSlider.setMajorTickSpacing (20);

      edgesSlider.setPaintLabels (true);

      edgesSlider.setPaintTicks (true);

      edgesSlider.setValue(20);

      edgesSlider.setLabelTable(edgesSlider.createStandardLabels(20,0));
