/*
 *	@(#)OrientedNoLabelCube.java 1.5 00/02/10 13:13:49
 *
...
public class OrientedNoLabelCube extends OrientedShape3D {
  ...
  private static final Point2f[] textureCoords = {
    new Point2f(1.0f, -0.5f),
    new Point2f(1.0f, 0.5f),
    new Point2f(0.0f, 0.5f),
    new Point2f(0.0f, -0.5f)
  };

  public OrientedNoLabelCube(Appearance appearance, float size, float widthScale) {
    super();
