...
class OffScreenCanvas3D extends Canvas3D {
   ...
   * @param path jpg path name, either with or without .jpg extension
   * @param dim dimensions of the image file to write
   * @param toWait forces program to wait till screen is rendered
   */
