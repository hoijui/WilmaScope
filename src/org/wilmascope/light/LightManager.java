 ...
 * <br>1 ambLightVector--contains all the ambient lights created.
 * <br>2 dirLightVector--contains all the directioanl lights created.
 * <br>3 pointLightVector--contains all the point lights created.
 * <br>4 spotLightVector--contains all the spot lights created.
 * <br>
 * <br>
 ...
 * </pre>
 * <br>parameter 1:the branch group the lights will be attached to
 * <br>parameter 2:the scheduling bounds of the lights
 * <br>parameter 3:the light properties file name.
 * <br>
 * <br>
 * Before showing the lightFrame,first disable all mouse picking and behavior capabilities.
 * And then add a window Listener to the lightFrame, so that when the frame is closed,
 * the mouse picking and behavior capabilites are reenabled:
 * <pre>
   ...
   // the constants file
    ...
    if(constants.getProperty("Light"+i+"PointColourR") == null)
     ...
     PointLight pl = new PointLight(
       constants.getColor3f("Light"+i+"PointColour"),
       new Point3f(constants.getVector3f("Light"+i+"PointPosition")),
       new Point3f(constants.getFloatValue("Light"+i+"PointAttenuationConstant"),
