...
public class Constants {
  ...
  public final static Vector3f vZero
    = gc.vZero;
  public final static float balancedThreshold
    = gc.getFloatValue("BalancedThreshold");
  public final static float velocityAttenuation
    = gc.getFloatValue("VelocityAttenuation");
  public final static float defaultEdgeLength
    = gc.getFloatValue("DefaultEdgeLength");
}
