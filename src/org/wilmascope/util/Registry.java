...
public class Registry<T extends Plugin> {
  ...
  protected Registry(String defaultPluginPropertyKey,String pluginListKey) {
    ...
    load(pluginListKey);
    try {
      defaultPlugin = getPlugin(GlobalConstants.getInstance()
          .getProperty(defaultPluginPropertyKey));
    } catch (UnknownTypeException e) {
      WilmaMain
          .showErrorDialog(
              defaultPluginPropertyKey+" specified in WILMA_CONSTANTS.properties file is unknown!",
              e);
    }
  }
