	...
	public class MenuBar extends JMenuBar {
		...
		void stretchMenuItem_actionPerformed(ActionEvent e) {
			...
			scaleSlider.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					JSlider source = (JSlider) e.getSource();
					graphControl.getGraphCanvas().setScale(
						new javax.vecmath.Vector3d(1, 0.1 * source.getValue(), 1));
				}
			});
		...
		void animationGranularityMenuItem_actionPerformed(ActionEvent e) {
			...
			animationGranularityControlFrame.setTitle(
		...
		void importMenuItem_actionPerformed(ActionEvent e) {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				FileImporter.load(graphControl,chooser.getSelectedFile().getAbsolutePath());
			}
		}
		...
		void aboutMenuItem_actionPerformed(ActionEvent e) {
			new About(null, "images" + java.io.File.separator + "WilmaSplash.png")
				.show();
		}
		...
		void backgroundColourMenuItem_actionPerformed(ActionEvent e) {
			java.awt.Color colour =
				JColorChooser.showDialog(
					this,
					"Please select nice colours...",
					graphControl.getGraphCanvas().getBackgroundColor());
			if (colour != null) {
