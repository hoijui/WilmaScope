...
public class Actions {
  ...
  public void init(final Component parent, final GraphControl graphControl,
    ...
    addEdgeAction = new AbstractAction("Add Edge", new ImageIcon(
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        controlPanel.add(new EdgePanel(controlPanel, graphControl
            .getRootCluster()));
    ...
    addClusterAction = new AbstractAction("Add Cluster", new ImageIcon(
      ...
      public void actionPerformed(ActionEvent e) {
        controlPanel.add(new ClusterPanel(controlPanel, graphControl
            .getRootCluster()));
        controlPanel.updateUI();
    ...
    pickableClusterAction = new AbstractAction("Make all clusters pickable",
        new ImageIcon(org.wilmascope.images.Images.class
            .getResource("pickableCluster.png"))) {
      public void actionPerformed(ActionEvent e) {
    ...
    configAction(fileOpenAction, "Open a previously saved graph.", "control O",
        'O', new ImageIcon(org.wilmascope.images.Images.class
    ...
    configAction(fileSaveAsAction, "Select a file name and save the graph.",
        "control A", 'A', new ImageIcon(org.wilmascope.images.Images.class
            .getResource("SaveAs16.gif")));
    ...
    configAction(fileSaveAction, "Save the graph.", "control S", 'S',
        new ImageIcon(org.wilmascope.images.Images.class
  ...
  private void configAction(Action a, String desc, String acc, char mn,
      ImageIcon smallIcon) {
    a.putValue(Action.SHORT_DESCRIPTION, desc);
    a.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(acc));
    a.putValue(Action.MNEMONIC_KEY, new Integer(
        Character.getNumericValue(mn) + 55));
  ...
  private JToolBar getToolbar() {
    ...
    JComponent component = (JComponent) toolbar.add(new DropDownButtonPanel(
        addNodeAction, ViewManager.getInstance().getNodeViewRegistry()));
    component.setToolTipText("Create a new Node");
    component = (JComponent) toolbar.add(new DropDownButtonPanel(addEdgeAction,
        ViewManager.getInstance().getEdgeViewRegistry()));
    component.setToolTipText("Create a new Edge");
    component = (JComponent) toolbar.add(new DropDownButtonPanel(
        addClusterAction, ViewManager.getInstance().getClusterViewRegistry()));
    ...
    toolbar.add(layoutAction)
        .setToolTipText("Adjust root Cluster Forces");
