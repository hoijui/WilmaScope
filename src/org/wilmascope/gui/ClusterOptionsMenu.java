...
public class ClusterOptionsMenu extends JPopupMenu implements OptionsClient {
  ...
  public ClusterOptionsMenu(Component parent, GraphControl gc,
  ...
  void clusterTypeMenu_menuSelected(MenuEvent e) {
    ViewManager.Registry reg = ViewManager.getInstance()
      ...
      clusterTypeMenuItem
          .addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
              ...
              try {
                cluster.setView(ViewManager.getInstance().createClusterView(
                    name));
                cluster.draw();
  ...
  void centerMenuItem_actionPerformed(ActionEvent e) {
    ...
    ((NodeView) cluster.getView()).getTransformGroup().getLocalToVworld(
        localToVworld);
  ...
  void removeFromMenuItem_actionPerformed(ActionEvent e) {
    controlPanel.add(new RemoveFromClusterPanel(controlPanel, cluster,
  ...
  void setLabelMenuItem_actionPerformed(ActionEvent e) {
    ...
    String label = JOptionPane.showInputDialog(parent,
        "What would you like to call this node?", "Node Label",
  ...
  void hideNonNeighboursMenuItem_actionPerformed(ActionEvent e) {
    ...
    NodeList allNodes = new NodeList(graphControl.getRootCluster().getCluster()
        .getNodes());
    for (Node n : allNodes) {
