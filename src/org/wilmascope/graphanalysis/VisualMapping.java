...
public abstract class VisualMapping {
  ...
  public void storeMapping(Cluster c, String analysisProperty) {
    ...
    if (existingMapping != null) {
      c.getProperties().setProperty(propertyKey,
          existingMapping + "," + analysisProperty + "-" + attributeName);
    } else {
      c.getProperties().setProperty(propertyKey,
          analysisProperty + "-" + attributeName);
    }
  }
  ...
  public static List<String> getClusterMappings(Cluster c) {
    String mappings = c.getProperties().getProperty(
        VisualMapping.propertyKey);
