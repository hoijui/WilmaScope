...
public class Node extends GraphElement {
   ...
   * recurse up the heirarchy of clusters until we meet a cluster to which both
   * nodes are members or sub-members
   */
  ...
  /**
   * set the view representing all visual aspects of the node and make the node
   * visible
   */
